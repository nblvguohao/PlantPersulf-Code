...
达到以下条件即可沟通，不需要等待 Nature 级完整模型：

1. 数据 registry 和 benchmark 已通过审计；
2. 防泄漏 split 已冻结；
3. 至少有传统基线和 ESM 基线；
4. 已知 SlWRKY6/SlERF.D2/BRG3 控制集恢复结果可展示；
5. 有 5–20 个初步番茄候选证据卡；
6. 清楚说明当前限制；
7. 准备好需要对方提供的数据和实验能力清单。
...
> 一个基于真实公共数据的植物硫巯基化位点优先排序框架。

### Level 2

> 该框架在新的番茄实验中前瞻性富集真实硫巯基化位点。

### Level 3

> 该框架揭示硫巯基化与磷酸化/泛素化串扰规律，并通过遗传和生化实验完成因果验证。

只有 Level 3 才适合认真按 Nature Communications 级故事组织。
