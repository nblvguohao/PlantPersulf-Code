...
\begin{figure}[!htbp]
\center{\includegraphics[width=\textwidth]{fig3_frozen_release.pdf}}
\caption{Frozen tomato candidate release.}
\label{fig:release}
\end{figure}

\begin{figure}[!htbp]
\center{\includegraphics[width=\textwidth]{fig4_preblind_calibration.pdf}}
\caption{Pre-blind calibration against published sites.}
\label{fig:calibration}
\end{figure}

\begin{figure}[!htbp]
\center{\includegraphics[width=\textwidth]{fig5_power_landscape.pdf}}
